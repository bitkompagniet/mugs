	...
	return [
		...
		async function(req, res) {
			try {
				...
				await mail.sendPassword(req.configuration('senderEmail'), req.configuration('smtp'), password, req.configuration('appName'), req.configuration('appUrl'), req.configuration('logoLink'), user);
